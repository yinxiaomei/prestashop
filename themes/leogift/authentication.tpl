...
{if !isset($email_create)}
	...
	<div class="row-fuild">
		<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="create-account_form" class="std span6 ">
			<fieldset>
		...
		<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="login_form" class="std span6">
			<fieldset>
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html'}" method="post" id="new_account_form" class="std clearfix form-horizontal">
		<fieldset>
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="account-creation_form" class="std form-horizontal">
		...
		<fieldset class="account_creation">
			...
			<div class="select control-group ">
				<label class="control-label" >{l s='Date of Birth'}</label>
				<div class="controls">
					<select id="days" name="days" class="span2">
						<option value="">-</option>
						{foreach from=$days item=day}
							<option value="{$day}" {if ($sl_day == $day)} selected="selected"{/if}>{$day}&nbsp;&nbsp;</option>
						{/foreach}
