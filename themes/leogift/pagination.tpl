...
{if isset($p) AND $p}
	...
	{if $start!=$stop}
		...
		{if $p != 1}
			...
			<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_previous"><a class="btn" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}">&laquo;&nbsp;</a></li>
		{else}
			<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="disabled pagination_previous"><span class="btn" >&laquo;&nbsp;</span></li>
		{/if}
		{if $start==3}
		...
		{if $pages_nb > 1 AND $p != $pages_nb}
			...
			<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_next"><a  class="btn" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}">&nbsp;&raquo;</a></li>
		{else}
			<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="disabled pagination_next"><span class="btn" >&nbsp;&raquo;</span></li>
		{/if}
		</ul>
	{/if}
