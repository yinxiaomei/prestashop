<div id="opc_new_account" class="opc-main-block block_box_center">
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std form-horizontal" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div id="opc_account_form">
				...
				<div class="checkbox is_customer_param control-group">
					<div class="controls">
					<input type="checkbox" name="invoice_address" id="invoice_address" autocomplete="off"/>
					<label for="invoice_address" class="help-inline"><b>{l s='Please use another address for invoice'}</b></label>
					</div>
				</div>
