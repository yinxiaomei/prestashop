...
{else}
	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<ul>
			{if !$PS_CATALOG_MODE}<li class="first_item item"><a href="{$link->getPageLink('prices-drop')}" title="{l s='Specials' mod='blockcms'}">{l s='Specials' mod='blockcms'}</a></li>{/if}
			...
			{if $display_poweredby}<li class="last_item item">{l s='Powered by' mod='blockcms'} <a class="_blank" href="http://www.prestashop.com">PrestaShop</a>&trade;</li>{/if}
		</ul>
	{$footer_text}
	</div>
	<!-- /MODULE Block footer -->
