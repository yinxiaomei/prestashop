		...
		<form id="id_new_comment_form" action="#">
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fl required"><sup>* {l s='Required fields' mod='productcomments'}</sup></p>
					<p class="fr">
						<button id="submitNewMessage" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>&nbsp;
						{l s='or' mod='productcomments'}&nbsp;<a href="#" class="btn" onclick="$.fancybox.close();">{l s='Cancel' mod='productcomments'}</a>
					</p>
					<div class="clearfix"></div>
				</div>
			</div>
