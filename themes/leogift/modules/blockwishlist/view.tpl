				...
				<div class="ajax_block_product wl_item">
					...
					<div class="address_address1 clear">
						<div class="btn_action">
							<a class="button_small clear btn" href="{$link->getProductLink($product.id_product,  $product.link_rewrite, $product.category_rewrite)}" title="{l s='View' mod='blockwishlist'}">{l s='View' mod='blockwishlist'}</a>
