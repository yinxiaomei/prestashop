...
class leobtslidermini extends Module
{
	...
	{
            if (!$this->isCached('leobtslidermini.tpl', $this->getCacheId()))
            {
		$this->_includeFile();
		$slideminir = array();
	...
	public function hookDisplayTop()
	{
		...
		return $this->display(__FILE__, 'leobtslidermini.tpl', $this->getCacheId());
	}
        public function clearCache()
        {
                $this->_clearCache('leobtslidermini.tpl');
        }
