...
dateFormat: 'yy-mm-dd'
    ...
    <style>
        ...
        #container_category_filter {
            float: left;
            height: 25px;
            line-height: 25px;
            margin-right: 5px;
        }
        #container_category_filter select {
            ...
            <tr>
                <td style="vertical-align: bottom;">
                    ...
                    <span style="float: right;">
                        {block name=extrafilter}
                        {if isset($category_tree)}
                            <div id="container_category_filter" >
                                <div id="category_filter" {if !$is_category_filter}style="display:none"{/if}>                                    
                                    {$category_tree}
                                </div>
                            </div>
                        {/if}
