 ...
 * loftwitter Class
 */	
class leocustomhtml1 extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomhtml1';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Slideshow Custom HTML');
		$this->description = $this->l('Slideshow Custom HTML, Support All hooks');
...
// 		return true;
		...
		$a = (parent::install() AND $this->registerHook('home'));
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<p><a class=\"box-shadow\" href=\"#\"><img src=\"".__PS_BASE_URI__."modules/leocustomhtml1/images/banner1.png\" alt=\"\" /></a> <a class=\"box-shadow\" href=\"#\"><img src=\"".__PS_BASE_URI__."modules/leocustomhtml1/images/banner.png\" alt=\"\" /></a></p>";
		}
    ...
    */
	function processHook($pparams, $pos="home"){
		...
		// delete img src
		$de_src = __PS_BASE_URI__ . '/modules/' . $this->name . '/images/delete.gif';
