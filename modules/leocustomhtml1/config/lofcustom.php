...
<h3><?php echo $this->l('Slideshow Custom HTML Module Configuration');?></h3>
<?php 
  ...
  <fieldset>
	...
	<?php
		...
		echo '
			...
			<div class="margin-form">
				<input type="radio" name="show_title" id="show_title_on" value="1" '.($this->getParamValue('show_title',0) ? 'checked="checked" ' : '').'/>
				<label class="t" for="show_title_on"> <img src="../img/admin/enabled.gif" alt="'.$this->l('Yes').'" title="'.$this->l('Yes').'" /></label>
				<input type="radio" name="show_title" id="show_title_off" value="0" '.($this->getParamValue('show_title',0) == 0 ? 'checked="checked" ' : '').'/>
