...
class BlockLeoRelatedProducts extends Module
{
	...
	public function install()
	{
		...
		$this->_clearCache('blockleorelatedproducts.tpl');
		return $a;
	}
	...
	{
		if (!$this->isCached('blockleorelatedproducts.tpl', $this->getCacheId())){
		...
		return $this->display(__FILE__, 'blockleorelatedproducts.tpl', $this->getCacheId());
	}
