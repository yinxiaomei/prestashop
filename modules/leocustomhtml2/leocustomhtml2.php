 ...
 * loftwitter Class
 */	
class leocustomhtml2 extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomhtml2';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Home Custom HTML 1');
		$this->description = $this->l('Home Custom HTML 1, Support All hooks');
    ...
    */
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<div class=\"row-fluid\"><a class=\"span4 box-shadow\" href=\"#\"><img src=\"".__PS_BASE_URI__."modules/leocustomhtml2/images/image1.jpg\" alt=\"\" /></a> <a class=\"span4 box-shadow\" href=\"#\"><img src=\"".__PS_BASE_URI__."modules/leocustomhtml2/images/image2.jpg\" alt=\"\" /></a> <a class=\"span4 box-shadow\" href=\"#\"><img src=\"".__PS_BASE_URI__."modules/leocustomhtml2/images/image3.jpg\" alt=\"\" /></a></div>";
		}
