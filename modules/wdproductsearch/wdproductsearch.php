...
class WdProductSearch extends Module {
    ...
    public function __construct() {
        ...
        $this->name = 'wdproductsearch';
        $this->tab = 'front_office_features';
        $this->version = '1.1.0';
        $this->author = 'hxn';
        $this->need_instance = 0;
        parent::__construct();
        $this->displayName = $this->l('WD Products Search');
    ...
    private function _includeFile() {
        ...
        $this->_html = '
<link href="' . __PS_BASE_URI__ . 'modules/wdproductsearch/css/bootstrap-trim.min.css" rel="stylesheet" type="text/css" />
<script type="text/javascript"  src="' . __PS_BASE_URI__ . 'modules/wdproductsearch/js/prettify.js"></script>
<script type="text/javascript"  src="' . __PS_BASE_URI__ . 'modules/wdproductsearch/js/bootstrap-trim.min.js"></script>
<script type="text/javascript"  src="' . __PS_BASE_URI__ . 'modules/wdproductsearch/js/options-custom.js"></script>
    ';
    }
...
//    			}
   		...
   		return $this->display(__FILE__, 'wdproductsearch.tpl');
    }
}