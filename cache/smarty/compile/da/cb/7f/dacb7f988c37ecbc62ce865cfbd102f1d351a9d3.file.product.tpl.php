<?php /* Smarty version Smarty-3.1.14, created on 2013-12-20 01:47:08
         compiled from "D:\xampp\htdocs\prestashop\themes\leogift\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2291252b306ece2e988-45283429%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dacb7f988c37ecbc62ce865cfbd102f1d351a9d3' => 
    array (
      0 => 'D:\\xampp\\htdocs\\prestashop\\themes\\leogift\\product.tpl',
      1 => 1387460356,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2291252b306ece2e988-45283429',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52b306f042cd77_71953535',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b306f042cd77_71953535')) {function content_52b306f042cd77_71953535($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_math')) include 'D:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_counter')) include 'D:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\function.counter.php';
?>
	...
	<div class="row-fluid">
		...
		<div id="pb-right-column" class="span6">
			<div class="row-fuild"> 
				...
				<!-- thumbnails -->
				<div id="views_block" class="<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)<2){?>hidden<?php }?> span3">
					<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>3){?><span class="view_scroll_spacer "><a id="view_scroll_left" class="hidden icon-angle-up" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
...
?>
					...
					<?php if ($_smarty_tpl->tpl_vars['accessory']->iteration%2==1){?>
					  <div class="row-fluid">
					<?php }?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)){?>
							...
							<div class="p-item span6 ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']){?> first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']){?> last_item<?php }else{ ?> item<?php }?> product_accessories_description">
...
" />
									...
									<div class="right_block">
										<p class="s_title_block">
											<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessoryLink']->value, 'htmlall', 'UTF-8');?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true),30,'...',true);?>
</a>
										</p>
...
" class="product_description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),50,'...');?>
</a>
											</div>
...
<?php }?></span>
					...
					<?php if (($_smarty_tpl->tpl_vars['accessory']->iteration%2==0||$_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last'])){?>
						</div>
					<?php }?>
