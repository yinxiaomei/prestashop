<?php /* Smarty version Smarty-3.1.14, created on 2013-12-23 00:30:07
         compiled from "D:\xampp\htdocs\prestashop\themes\leogift\pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2042652b6e95f499185-35561254%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8922f5277e3dc6639db073f11767e48241217ccb' => 
    array (
      0 => 'D:\\xampp\\htdocs\\prestashop\\themes\\leogift\\pagination.tpl',
      1 => 1387460356,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2042652b6e95f499185-35561254',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52b6e9601610d3_20802403',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b6e9601610d3_20802403')) {function content_52b6e9601610d3_20802403($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php }?>" class="pagination_previous"><a class="btn" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
">&laquo;&nbsp;</a></li>
		<?php }else{ ?>
			<li id="pagination_previous<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)){?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_previous"><span class="btn" >&laquo;&nbsp;</span></li>
		<?php }?>
...
<?php }?>" class="pagination_next"><a  class="btn" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
">&nbsp;&raquo;</a></li>
		<?php }else{ ?>
			<li id="pagination_next<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)){?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_next"><span class="btn" >&nbsp;&raquo;</span></li>
		<?php }?>
		</ul>
	<?php }?>
