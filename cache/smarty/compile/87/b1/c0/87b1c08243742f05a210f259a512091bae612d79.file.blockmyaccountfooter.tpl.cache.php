<?php /* Smarty version Smarty-3.1.14, created on 2013-12-20 00:40:41
         compiled from "D:\xampp\htdocs\prestashop\themes\leogift\modules\blockmyaccountfooter\blockmyaccountfooter.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52b2f7597e4f58_83759795',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b2f7597e4f58_83759795')) {function content_52b2f7597e4f58_83759795($_smarty_tpl) {?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My account','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
	...
	<div class="block_content">
		<ul class="bullet">
			<li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('history',true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My orders','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['returnAllowed']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-follow',true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My merchandise returns','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-slip',true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My credit slips','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('addresses',true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My addresses','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('identity',true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My personal info','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['voucherAllowed']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('discount',true);?>
